    ...
    GovernorTimelockControl
{
    ...
    ) Governor("AutonoGovernor") GovernorVotes(_token) GovernorVotesQuorumFraction(2) GovernorTimelockControl(_timelock) {}
